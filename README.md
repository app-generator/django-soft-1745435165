...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-1745435165) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-soft-1745435165.git
$ cd django-soft-1745435165
```
